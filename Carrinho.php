...
<body>
 ...
 <br><hr>
 <?php
				echo "Nome: " . $row_servicos['plantao'] . "<br>";
        echo "Descrição " . $row_servicos['descricao'] . "<br>";
        echo "Valor: R$ " . $row_servicos['valor'] . "<br>";
				echo "<a href='painel.php"."'>Remover serviço</a><br>";
    ...
    <?php
		...
		if($SendPesqUser){
			...
			while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
				...
				echo "<a href='solicitação.php?idPrestador=" . $row_usuario['idPrestador'] . "'>Solicitar Prestador</a><br>";
			}
		}
        ...
        $result_prestador = "SELECT * FROM prestador LIMIT $inicio, $qnt_result_pg";
            ...
            echo "COREN: ".$row_prestador['coren']."<br>";
          	echo "<a href='historico.php?idServicos=".$row_servicos['idServicos'] ."&idPrestador=" . $row_prestador['idPrestador'] . "'>Solicitar Prestador</a><br>";
        }
